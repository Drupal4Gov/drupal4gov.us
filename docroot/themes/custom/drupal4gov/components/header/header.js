...
((Drupal, once, tabbable) => {
  ...
  /**
   * Checks if mobile navigation is open.
   *
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.currentTheme.areAnySubNavsOpen()) {
          props.currentTheme.closeAllSubNav();
        } else {
      ...
      if (e.key === 'Tab' && isNavOpen(props.navWrapper)) {
        ...
        if (e.shiftKey) {
          if (
            ...
            !props.currentTheme.isDesktopNav()
          ) {
    ...
    window.addEventListener('resize', () => {
      if (props.currentTheme.isDesktopNav()) {
        toggleNav(props, false);
      ...
      Drupal.currentTheme.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.currentThemeNavigation = {
    attach(context) {
