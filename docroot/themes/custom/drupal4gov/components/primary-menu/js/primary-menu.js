...
((Drupal) => {
  const { isDesktopNav } = Drupal.currentTheme;
  ...
  Drupal.currentTheme.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.currentTheme.isDesktopNav()) return;
  ...
  Drupal.currentTheme.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.currentTheme.areAnySubNavsOpen = areAnySubNavsOpen;
